          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className={`${glassCard} overflow-hidden`}>
                <nav className="flex flex-col">
                  {[
                    { icon: <User size={20} />, label: "Personal Info", active: true },
                    { icon: <Plane size={20} />, label: "My Bookings", active: false },
                  ...
                  <button className="flex items-center gap-3 px-6 py-4 font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 text-left border-l-4 border-transparent">
                    <LogOut size={20} />
                    Log Out
                  </button>
                </nav>
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                 {[
                   { label: "Total Trips", value: "14", icon: <Plane size={24} className="text-teal-500" /> },
                   { label: "Reviews", value: "28", icon: <User size={24} className="text-cyan-500" /> },
                   { label: "Points", value: "4,500", icon: <Shield size={24} className="text-emerald-500" /> },
                   { label: "Countries", value: "7", icon: <MapPin size={24} className="text-blue-500" /> },
                 ].map((stat, i) => (
                    <div key={i} className={`${glassCard} p-5 flex flex-col justify-center items-center md:items-start`}>
                      ...
                      <span className="text-xs md:text-sm text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">{stat.label}</span>
                    </div>
                 ))}
              </div>
               ...
               <div className={`${glassPanel} p-8`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                     <div className="space-y-2">
                       <label className="block text-sm font-semibold text-slate-600 dark:text-slate-400">First Name</label>
                     ...
                     <div className="space-y-2">
                       <label className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Last Name</label>
                       <div className="w-full px-4 py-3 rounded-xl bg-white/40 dark:bg-black/20 border border-white/50 dark:border-white/10 shadow-sm text-slate-800 dark:text-slate-200 font-medium font-sans flex items-center gap-3">
                         <User size={18} className="text-slate-400" />
                         <span>Morgan</span>
                       </div>
                     ...
                     <div className="space-y-2">
                       <label className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Date of Birth</label>
                       <div className="w-full px-4 py-3 rounded-xl bg-white/40 dark:bg-black/20 border border-white/50 dark:border-white/10 shadow-sm text-slate-800 dark:text-slate-200 font-medium font-sans flex items-center gap-3">
                     ...
                     <div className="space-y-2">
                       <label className="block text-sm font-semibold text-slate-600 dark:text-slate-400">Location</label>
                       <div className="w-full px-4 py-3 rounded-xl bg-white/40 dark:bg-black/20 border border-white/50 dark:border-white/10 shadow-sm text-slate-800 dark:text-slate-200 font-medium font-sans flex items-center gap-3">
                   ...
                   <div className="space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-6 p-4 rounded-2xl bg-white/30 dark:bg-black/30 border border-white/30 dark:border-white/5 transition-colors hover:bg-white/40 dark:hover:bg-black/40">
                         <div className="w-full sm:w-32 h-24 rounded-xl overflow-hidden shadow-sm flex-shrink-0">
                            <img src="https://images.unsplash.com/photo-1499856871958-5b9627545d1a?auto=format&fit=crop&q=80&w=400" alt="Paris" className="w-full h-full object-cover" />
                         </div>
                         ...
                         <div className="flex-shrink-0 w-full sm:w-auto text-center sm:text-right">
                             <p className="text-xlg font-extrabold text-slate-900 dark:text-white">$2,450</p>
                             <button className="mt-2 text-sm font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300">View Details</button>
                         </div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-6 p-4 rounded-2xl bg-white/30 dark:bg-black/30 border border-white/30 dark:border-white/5 transition-colors hover:bg-white/40 dark:hover:bg-black/40">
                         <div className="w-full sm:w-32 h-24 rounded-xl overflow-hidden shadow-sm flex-shrink-0">
                            <img src="https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&q=80&w=400" alt="Tokyo" className="w-full h-full object-cover" />
                         </div>
                         <div className="flex-grow w-full text-center sm:text-left">
                            <h4 className="text-lg font-bold mb-1">Tokyo Adventure</h4>
                            <p className="text-sm text-slate-600 dark:text-slate-400 font-medium mb-2 flex items-center justify-center sm:justify-start gap-1">
                         ...
                         <div className="flex-shrink-0 w-full sm:w-auto text-center sm:text-right">
                             <p className="text-xlg font-extrabold text-slate-900 dark:text-white">$3,100</p>
                             <button className="mt-2 text-sm font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300">View Details</button>
                         </div>
                      </div>
                   </div>
