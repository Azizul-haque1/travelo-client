      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center items-center p-6 mt-10 mb-20">
          ...
          <div className={`${glassCard} w-full max-w-md p-8 md:p-10 relative overflow-hidden`}>
            ...
            <form className="relative z-10 space-y-6 flex flex-col">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1 mr-1">
                  ...
                  <a href="#" className="text-sm font-semibold text-teal-600 dark:text-teal-400 hover:underline">Forgot password?</a>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="relative z-10 mt-8 mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-transparent text-slate-500 dark:text-slate-400 font-medium">Or continue with</span>
              </div>
            </div>
          ...
          <p className="mt-8 text-slate-700 dark:text-slate-300 font-medium z-10">
            Don't have an account? <Link href="/signup" className="font-bold text-teal-600 dark:text-teal-400 hover:underline">Sign up</Link>
          </p>
